...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\ActionLab\\Downloads\\staircase_psy\\staircase_psy\\Adaptive_staircase_Diar_lastrun.py',
...
asr = ASR(0.05, 0.9, 0.05) # Attack (A) susain (S) Release (R)
sig2 = sin * asr * amp
...
stair = data.StairHandler(startVal=90.0, extraInfo=expInfo,
...
level = thisStair = 90.0  # initialise some vals
...
for thisStair in stair:
    ...
    if level==125:
        ...
        CorrectAns='d'
    # keep track of which components have finished
    Adap_staircaseComponents = [trial_resp, response, ISI, ISI_2]
    ...
    while continueRoutine:
        ...
        # *ISI_2* period
        if ISI_2.status == NOT_STARTED and t >= 1-frameTolerance:
            # keep track of start time/frame for later
